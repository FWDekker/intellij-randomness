...
abstract class DataInsertAction : AnAction() {
    ...
    /**
     * Inserts the data generated by [generateString] at the caret(s) in the editor; one datum for each caret.
     *
     * @param event carries information on the invocation place
     */
    override fun actionPerformed(event: AnActionEvent) {
        ...
        WriteCommandAction.runWriteCommandAction(project) {
            try {
                editor.caretModel.allCarets.forEach { caret ->
                    ...
                    editor.document.replaceString(start, end, string)
...
abstract class DataInsertArrayAction(private val dataInsertAction: DataInsertAction) : DataInsertAction() {
    ...
    /**
     * Generates an array-like string of random data.
     *
     * @return an array-like string of random data
     * @throws DataGenerationException if data could not be generated
     */
    @Throws(DataGenerationException::class)
